...
use panix\ext\multipleinput\assets\MultipleInputAsset;
use panix\ext\multipleinput\assets\MultipleInputSortableAsset;
...
abstract class BaseRenderer extends BaseObject implements RendererInterface
{
    ...
    private function prepareButtons()
    {
        ...
        if (!array_key_exists('class', $this->removeButtonOptions)) {
            $this->removeButtonOptions['class'] = $this->isBootstrapTheme() ? 'btn btn-sm btn-danger' : '';
        }
        ...
        if (!array_key_exists('class', $this->addButtonOptions)) {
            $this->addButtonOptions['class'] = $this->isBootstrapTheme() ? 'btn btn-sm btn-success' : '';
        }
        ...
        if (!array_key_exists('class', $this->cloneButtonOptions)) {
            $this->cloneButtonOptions['class'] = $this->isBootstrapTheme() ? 'btn btn-sm btn-info' : '';
        }
