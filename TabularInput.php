...
/**
 * Class TabularInput
 * @package panix\ext\multipleinput
 */
class TabularInput extends Widget
{
     ...
     * Defaults to `panix\ext\multipleinput\TabularColumn`
     */
    public $columnClass;

    /**
     * @var string the name of renderer class. Defaults to `panix\ext\multipleinput\renderers\TableRenderer`.
     * @since 1.4
     */
